...
\title{Direct Observation of Electron Trajectories During Atomic Transitions via Categorical Measurement}
...
\newpage
\input{sections/categorical-measurement}
\newpage
\input{sections/experimental-setup}
\newpage
\input{sections/measurement-protocol}
\newpage
